...
#include "VFDNeutronHPMadlandNixSpectrum.hh"
#include "G4SystemOfUnits.hh"

  G4double VFDNeutronHPMadlandNixSpectrum::Madland(G4double aSecEnergy, G4double tm)
  {
    G4double result;
  ...
  G4double VFDNeutronHPMadlandNixSpectrum::Sample(G4double anEnergy)
  {
    G4double tm = theMaxTemp.GetY(anEnergy)*10; //The temperatures in the G4NDL files seem to be off by a factor of 10 so I added this to see if it fixes the energy dist
  ...
  G4double VFDNeutronHPMadlandNixSpectrum::
